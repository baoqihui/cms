...
public class DrugController {
    ...
    public Result<PageResult> list(@RequestBody Map<String, Object> params) {
        Page<Map> list= drugService.findList(params);
    ...
    @PostMapping("/sel/{id}")
    public Result findDrugById(@PathVariable Long id) {
        Drug model = drugService.getById(id);
    ...
    public Result saveBatch(@RequestBody Map<String,List<Drug>> map) {
        List<Drug> models = map.get("models");
        drugService.saveOrUpdateBatch(models);
        return Result.succeed("保存成功");
    }
